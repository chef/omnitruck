...
ruby s3-parse-manifest-json.rb "client_migrate_manifest_names" $ACCESS_KEY $SECRET_KEY "opscode-omnitruck-release" "chef-platform-support" "s3-client-backup"
...
ruby s3-parse-manifest-json.rb "server_migrate_manifest_names" $ACCESS_KEY $SECRET_KEY "opscode-omnitruck-release" "chef-platform-support" "s3-server-backup"
